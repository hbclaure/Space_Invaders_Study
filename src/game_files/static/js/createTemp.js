...
{	
    ...
    player_ship2 = this.create_ship("ship", 0, this.sys.canvas.width / 4, 540);
    players.push(player_ship);
    players.push(player_ship2);
    console.log(players);
    ...
    enemies_right = this.create_enemies(4, 300, 0, "b", 5, 10, "enemylaser", min_x = 550, max_x = 800);
    enemies_middle = this.create_enemies(4, 630, 0, "a", 5, 10, "enemylaser", min_x = 280, max_x = 525);

    for (let i = 0; i < 2; i++) {

        // --> enemies hit by player_ship bullets 
        this.physics.add.collider(enemies_left.enemies_group, players[i].bullets_group, (enemy, bullet) => {
            // destroy the enemy
            ...
            // update the score     
            if (enemy.hit == false) {   
            players[i].sprite.props.score += enemy.score;
        ...
        this.physics.add.collider(enemies_right.enemies_group, players[i].bullets_group, (enemy, bullet) => {
            // destroy the enemy
            this.custom_sounds.enemy_explosion.play();
            enemy.play(enemy.explote_anim, true);
            enemy.on('animationcomplete', () => {
        ...
        this.physics.add.collider(enemies_left.bullets_group, players[i].bullets_group, (enemy_bullet, ship_bullet) => {
            // hide both bullets 
        ...
        this.physics.add.collider(enemies_right.bullets_group, players[i].bullets_group, (enemy_bullet, ship_bullet) => {
            // hide both bullets 
            enemy_bullet.body.x = this.sys.canvas.width;
            enemy_bullet.body.y = this.sys.canvas.height;
            ship_bullet.body.x = this.sys.canvas.width;
        ...
        this.physics.add.collider(players[i].sprite, enemies_left.bullets_group, (ship_sprite, bullet) => {
            // hide the bullet 
            bullet.body.x = this.sys.canvas.width;
            bullet.body.y = this.sys.canvas.height;
            bullet.setActive(false);
        ...
        this.physics.add.collider(players[i].sprite, enemies_right.bullets_group, (ship_sprite, bullet) => {
            // hide the bullet 
            bullet.body.x = this.sys.canvas.width;
            bullet.body.y = this.sys.canvas.height;
            bullet.setActive(false);
        ...
        this.physics.add.collider(players[i].sprite, enemies_left.enemies_group, (ship_sprite, enemy) => {
            if (!enemy.hit) {
                // play sounds
                this.custom_sounds.player_explosion.play();
                this.custom_sounds.enemy_explosion.play();
        ...
        this.physics.add.collider(players[i].sprite, enemies_right.enemies_group, (ship_sprite, enemy) => {
            if (!enemy.hit) {
                // play sound
                this.custom_sounds.player_explosion.play();
                this.custom_sounds.enemy_explosion.play();
