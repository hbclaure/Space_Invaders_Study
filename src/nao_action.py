...
class NaoAction():
    ...
    def nao_action_cb(self,msg):
        ...
        if robot_action == "hi" and not(self.said):
            ...
            print("reset")
            self.said = False
        elif robot_action == "ask_for_feedback" and not(self.said):
    ...
    def sleep(self):
        self.tts_proxy.setVolume(1.5)
        self.tts_proxy.say("That was a good game. I'm going to sleep!")
    ...
    def wake(self):
        ...
        self.tts_proxy.say("Hello, I'm ready to play!")
