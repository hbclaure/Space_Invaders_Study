...
gameover_scene.create = function() {
    ...
    var font_type = (mode == UNCOOPERATIVE) ? 'PressStart2P_Orange' : 'PressStart2P_Gray';
    var ai_text = this.add.bitmapText(400, 350, 'PressStart2P_Orange', 'Co-Player Final Score: ' + ai_score, 20).setOrigin(0.5).setCenterAlign();
